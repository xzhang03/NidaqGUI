...
nicfg.ArduinoCOM       = 34;%5;             % Set the COM port for the Arduino, < 0 means off
...
nicfg.optophotometry.cycle = 5; % Train cycle in seconds. E.g., 30 means 30 seconds from start to start. Default 30.
...
nicfg.scheduler.ntrains = 4; % Number of trains. Default 10.
...
nicfg.scheduler.randomITI_min = 4; % Lowest value of ITI (inclusive, in seconds). Applies to both optophotometry and scoptophotometry
nicfg.scheduler.randomITI_max = 8; % Highest value of ITI (exclusive, in seconds). Applies to both optophotometry and scoptophotometry
