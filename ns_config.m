...
nicfg.picoDAQparams     = {'daqcom', 'COM23', 'frequency', nicfg.NidaqFrequency}; % Parameters to be parsed
...
nicfg.serveradd = {...
    'SZ', '\\zhanglab.cns.nyu.edu\server\photometry';...
    'JB', '\\zhanglab.cns.nyu.edu\server\photometry';...
    'TM', '\\zhanglab.cns.nyu.edu\server\photometry';...
    'AM', '\\zhanglab.cns.nyu.edu\server\photometry';...
    'CA', '\\zhanglab.cns.nyu.edu\server\photometry';...
    };
...
% Scheduler
nicfg.scheduler.enable = 0; % 2 PWMINT (native), 1 PWMRGB (i2c), 0 off
...
nicfg.optodelayTTL.ntrialtypes = 1; % Multiple trial types (Max is 4). Only this many trial types will be done.
