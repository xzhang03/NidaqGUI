classdef pointingdevice < dynamicprops
    ...
    methods
        function obj = pointingdevice(adaptor,DeviceID)
            ...
            obj.NoButton = strcmp(adaptor,'mouse') & strcmp(obj.hwInfo.ID,'1');
        end
        function delete(obj)
            for m=1:length(obj)
        ...
        function set.NumInput(obj,val)
            mdqmex(55,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'NumInput',numchk(obj,val));
        end
        function val = get.NumInput(obj)
            val = mdqmex(56,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'NumInput');
        end
