...
nicfg.scoptophotometry.cycle = 25; % Train cycle in seconds. E.g., 30 means 30 seconds from start to start. Default 30.
...
nicfg.scheduler.ntrains = 180; % Number of trains. Default 10.
...
nicfg.optodelayTTL.deliverydur = 30; % Duration in 100 ms. E.g., 50 means 5 seconds. Default 50 (5s)
