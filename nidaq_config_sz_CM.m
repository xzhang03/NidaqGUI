...
nicfg.scoptophotometry.pulsewidth = 6; % Pulth width in ms. E.g., 10 means 10 ms pulses. Default 10.

% Scheduler
nicfg.scheduler.enable = true; % Default false
nicfg.scheduler.delay = 500 % Delayed opto start in seconds. E.g., 120 means 2 min delay. Default 120s.
...
nicfg.optodelayTTL.delay = 50; % Delay in 100 ms. E.g., 20 means 2 seconds. Default 20 (2s)
