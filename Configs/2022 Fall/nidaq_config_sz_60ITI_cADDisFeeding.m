...
nicfg.optophotometry.pulsewidth = 14; % Pulth width in ms. E.g., 10 means 10 ms pulses. Default 10. Going above 19 may cause issues.
...
nicfg.scheduler.delay = 300; % Delayed opto start in seconds. E.g., 120 means 2 min delay. Default 120s. Max 2550s.
